...
const Footer = () => {
  ...
  return (
    <footer className="bg-blue-900 py-4 text-gray-300 font-Unbounded">
        ...
        <div className="footer-container grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
          ...
          <div className="contact-form">
            ...
            <form id="contactForm" ref={form} onSubmit={sendEmail} className="flex flex-col space-y-2">
              ...
              <button
                type="submit"
                className="bg-silver hover:bg-blue-500 transition-all duration-300 text-white rounded p-1 text-xs"
              >
                Enviar
              </button>
            </form>
          ...
          <div className="social-media">
            ...
            <form id="newsletter" className="flex items-center" ref={form} onSubmit={sendEmail}>
              ...
              <button
                type="submit"
                className="bg-silver hover:bg-blue-500 transition-all duration-300 text-white rounded p-1 ml-2 text-xs"
              >
                Inscreva-se
              </button>
            </form>
