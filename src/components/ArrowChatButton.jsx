  ...
  return (
    <>
      ...
      <div className="fixed bottom-5 right-5 z-50">
        <button
          className="bg-blue-700 text-white p-4 rounded-full shadow-lg hover:bg-blue-500 transition-all duration-300"
          onClick={toggleChat}
        >
          {isOpen ? (
      ...
      {/* Chatbot popup */}
      {isOpen && (
        <div className="fixed bottom-16 right-5 w-80 h-[26rem] bg-white shadow-lg rounded-lg p-4 z-50"> {/* Certifique-se de que o z-50 mantém o chat acima dos elementos */}
          <div className="flex justify-between items-center border-b pb-2 mb-4">
            <h3 className="text-lg font-bold text-blue-700">Tourinho</h3>
            <button className="text-blue-700 hover:text-blue-500" onClick={toggleChat}>
              &#x2715;
            </button>
          </div>
          ...
          <div className="mb-4">
            ...
            <select
              ...
              className="w-full border rounded-lg p-2 text-sm text-blue-700"
            >
          ...
          <form className="flex items-center justify-between" onSubmit={sendMessage}>
            <button
              type="submit"
              className="bg-blue-700 text-white p-2 rounded-lg w-full text-center"
            >
              Enviar
            </button>
          </form>
