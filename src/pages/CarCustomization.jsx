...
const CarCustomization = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-6 bg-white text-black">
      <h1 className="text-4xl font-bold text-center mb-6 text-blue-900">Personalize o Carro da Fórmula E</h1>
      
      {/* Menu de opções detalhadas */}
      <div className="options-menu grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        {/* Aerodinâmica */}
        <div className="flex flex-col items-center">
          <h3 className="font-bold text-blue-900 mb-2">Aerodinâmica</h3>
          <select
            value={selectedAerodynamics}
            onChange={(e) => handleModificationChange('aerodynamics', e.target.value)}
            className="p-3 rounded-lg bg-gray-100 text-gray-900 w-full border border-gray-300"
          >
        ...
        {/* Motor */}
        <div className="flex flex-col items-center">
          <h3 className="font-bold text-blue-900 mb-2">Motor</h3>
          <select
        ...
        {/* Pneus */}
        <div className="flex flex-col items-center">
          <h3 className="font-bold text-blue-900 mb-2">Pneus</h3>
          <select
            value={selectedTires}
        ...
        {/* Suspensão */}
        <div className="flex flex-col items-center">
          <h3 className="font-bold text-blue-900 mb-2">Suspensão</h3>
          <select
      ...
      <div className="performance-bars mb-6">
        <h3 className="text-lg font-semibold text-blue-900 mb-2">Desempenho</h3>
        <div className="mb-4">
      ...
      <div className="modification-description bg-blue-100 p-4 rounded-lg text-blue-900 shadow-lg">
